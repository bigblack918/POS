...
/*		showAnim: 'show', // Name of jQuery animation for popup
		...
		showBigPrevNext: true, // True to show big prev/next links
...
$.extend(Datepick.prototype, {
	...
	_connectDatepick: function(target, inst) {
		...
		if (showOn == 'button' || showOn == 'both') { // Pop-up date picker when button clicked
			...
			var trigger = $(this._get(inst, 'buttonImageOnly') ?
				$('<img class="dc"/>').addClass(this._triggerClass[useTR]).
	...
	_showDatepick: function(input) {
		...
		var www = inst.dpDiv.width();
		if (offset.left + www > $("body").width()) {
			offset.left -= (offset.left + www - $("body").width() + 10);
		}
...
/*		var clear = (this._get(inst, 'mandatory') ? '' :
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		if (secondary || !changeYear)
			...
			var formatYear = $.datepick.formatYear ? $.datepick.formatYear : function(v){return v;}
